...
[ies-repovault]
name=ies-repovault
baseurl=http://ies-repovault.ies.mentorg.com/repovault/rhel/<%= node['platform_version'] %>/os/`uname -i`/
enabled=1
gpgcheck=0
...
[ies-repopatch]
name=ies-repopatch
baseurl=http://ies-repovault.ies.mentorg.com/repovault/rhel/patch/7/os/`uname -i`/
enabled=1
gpgcheck=0
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-redhat-release
EOF
